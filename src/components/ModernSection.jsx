...
function ModernSection() {
	return (
		<div className='shadow-lg backdrop-blur-[100px] self-center pt-0 pb-0 pl-24 pr-1 rounded-2xl border-[1.772px] border-solid border-white max-md:max-w-full max-md:pl-5 relative bottom-28 right-0 w-11/12'>
				...
				<div className='flex flex-col items-stretch w-[38%] max-md:w-full max-md:ml-0'>
					<div className='items-start flex mr-0 flex-col my-auto max-md:max-w-full max-md:mt-10'>
						...
						<div className='text-black text-lg leading-8 self-stretch mt-8 max-md:max-w-full'>
							Introducing a powerful solution that will change how you sell and
							manage a retail outlet at all levels, from small shops to
							supermarkets
						</div>
